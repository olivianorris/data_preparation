...
class FaceReconModel(BaseModel):
    ...
    def forward(self):
        ...
        assert self.net_recog.training == False#New10,8
        ...
        self.output_coeffs_tosave = output_coeff#New12
    ...
    def savedata(self):
        """
        self.image_pathsのパスを操作し、適切な保存位置へ保存
        image_folder/aaa.png→image_folder/aaa
        →image_folder aaa
        gt_feat, output_coeff, avgpoolをそれぞれの名前のフォルダの元に保存
        保存できていることを確認するために、forループの内部にもし存在すればその実行をパスできるような仕組みを作る
        #New12
